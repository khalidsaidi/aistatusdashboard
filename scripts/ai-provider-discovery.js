  ...
  },
  {
    ...
    providers: [
      ...
      },
      {
        ...
        statusUrl: 'https://status.together.xyz',
      },
      {
        name: 'Fireworks AI',
...
async function discoverNewProviders() {
  ...
  const totalCandidates = DISCOVERY_SOURCES.reduce(
    (sum, source) => sum + (source.providers ? source.providers.length : 0),
    0
  );
