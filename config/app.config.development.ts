...
export const DEV_CONFIG: AppConfig = {
  environment: {
    ...
    apiBaseUrl: process.env.NEXT_PUBLIC_API_BASE_URL || 'https://us-central1-ai-status-dashboard-dev.cloudfunctions.net',
  },
  ...
  firebase: {
    projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'ai-status-dashboard-dev',
    functions: {
