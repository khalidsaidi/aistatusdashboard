...
const FIREBASE_FUNCTIONS = {
  ...
  UNSUBSCRIBE_EMAIL:
    'https://us-central1-ai-status-dashboard-dev.cloudfunctions.net/unsubscribeEmail',
  SUBSCRIBE_WEBHOOK:
    'https://us-central1-ai-status-dashboard-dev.cloudfunctions.net/subscribeWebhook',
  SUBSCRIBE_PUSH: 'https://us-central1-ai-status-dashboard-dev.cloudfunctions.net/subscribePush',
  UNSUBSCRIBE_PUSH:
    'https://us-central1-ai-status-dashboard-dev.cloudfunctions.net/unsubscribePush',
  SEND_TEST_NOTIFICATION:
    'https://us-central1-ai-status-dashboard-dev.cloudfunctions.net/sendTestNotification',
  SEND_TEST_PUSH:
    'https://us-central1-ai-status-dashboard-dev.cloudfunctions.net/sendTestPushNotification',
};
