...
exports.processStatusJob = (0, firestore_1.onDocumentCreated)(
  'statusJobs/{jobId}',
  async (event) => {
    var _a;
    ...
    try {
      ...
      firebase_functions_1.logger.info(
        `Successfully processed job for provider ${jobData.providerId}`
      );
    } catch (error) {
      firebase_functions_1.logger.error(
        `Failed to process job for provider ${jobData.providerId}:`,
        error
      );
      // Handle retry logic
...
function parseStatusFromResponse(data, format) {
  ...
  try {
    switch (format) {
      case 'statuspage_v2':
        const indicator =
          ((_a = data === null || data === void 0 ? void 0 : data.status) === null || _a === void 0
            ? void 0
            : _a.indicator) || 'unknown';
        switch (indicator) {
          case 'none':
            return 'operational';
          case 'minor':
