export default function Footer() {
  return (
    <footer role="contentinfo" className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
            This dashboard is provided for informational and reference purposes only. 
            We assume no responsibility for accuracy, completeness, or any decisions made based on this information.
          </p>
        </div>
        ...
        <div className="text-center mb-6">
          <p className="text-xs text-gray-500 dark:text-gray-500">
            All trademarks and logos are the property of their respective owners and are used here for identification purposes only.
        ...
        <div className="text-center border-t border-gray-200 dark:border-gray-700 pt-6 mb-4">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-500">
            <a href="/api/health" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">System Health</a>
            {' • '}
            <a href="/api/status" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">JSON API</a>
          </p>
        </div>
