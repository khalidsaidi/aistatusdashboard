...
export function SkeletonCard({ className = '' }: SkeletonProps) {
  return (
    <div
      className={`animate-pulse bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700 ${className}`}
    >
...
export function SkeletonComment({ className = '' }: SkeletonProps) {
  return (
    <div
      className={`animate-pulse bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700 ${className}`}
    >
