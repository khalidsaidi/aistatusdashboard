...
test.describe('Comments Feature', () => {
  ...
  test('should validate comment form inputs', async ({ page }) => {
    ...
    await page.fill(
      ...
      'This is a test comment with enough characters'
    );
  ...
  test('should load existing comments', async ({ page }) => {
    ...
    if (hasComments === 0) {
      ...
      await expect(
        page.locator('text=No comments yet. Be the first to share your thoughts!')
      ).toBeVisible();
    } else {
  ...
  test('should handle comment actions', async ({ page }) => {
    ...
    await page.fill(
      'textarea[placeholder="Share your thoughts..."]',
      'This is a test comment for action testing'
    );
    await page.click('button:has-text("Post Comment")');
  ...
  test('should refresh comments list', async ({ page }) => {
    ...
    await expect(
      page
        .locator('button:has-text("🔄 Loading...")')
        .or(page.locator('button[disabled]:has-text("🔄")'))
  ...
  test('should handle rate limiting gracefully', async ({ page }) => {
    ...
    await page.fill(
      'textarea[placeholder="Share your thoughts..."]',
      'This is a test comment for rate limiting'
    );
