        ...
        it('should return valid status data from real API', async () => {
          ...
          if (provider.id === 'huggingface') {
            ...
            mockFetch.mockResolvedValueOnce({
              ...
              status: 200,
              text: async () =>
                '<!DOCTYPE html><html><head><title>Status</title></head><body>All systems operational</body></html>',
            });
            ...
            mockFetch.mockResolvedValueOnce({
              ...
              status: 200,
              text: async () =>
                '<?xml version="1.0"?><rss><channel><title>Status</title></channel></rss>',
            });
            ...
            mockFetch.mockResolvedValueOnce({
              ...
              status: 200,
              text: async () =>
                '<!DOCTYPE html><html><head><title>Perplexity Status</title></head><body>All systems operational</body></html>',
            });
          } else {
